...
const History = () => {
  ...
  const handleDeleteRecord = async (recordId) => {
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        const response = await fetch(
          `/history/delete-usage-record/${recordId}`,
          {
            method: "DELETE",
            credentials: "include",
          }
  ...
  const columns = [
    ...
    },
    {
      name: "Start Time",
      selector: (row) =>
        row.timing.start_time
          ? new Date(row.timing.start_time).toLocaleString()
          : "N/A",
      sortable: true,
    },
    {
      ...
      selector: (row) =>
        row.timing.end_time ? (
          new Date(row.timing.end_time).toLocaleString()
        ) : (
          <em>In Progress</em>
        ),
      sortable: true,
    ...
    <div className="history-container">
      <div className="container-fluid py-4">
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <div>
            <a
              href="/admin_dashboard/reservation"
              ...
              <div className="modal-body">
                <div className="row mb-4">
                  <div className="col-md-6">
                    ...
                    <p>
                      <strong>Device ID:</strong> {selectedRecord.device_id}
                    </p>
                  </div>
                  <div className="col-md-6">
